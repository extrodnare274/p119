...
def get_stem_words(words, ignore_words):
    ...
    for word in words:
        ...
        if lowercased_word not in stop_words:
            ...
            stemmed_word = porter_stemmer.stem(lowercased_word)
            stem_words.append()
...
def preprocess_train_data():
    ...
    with open('stem_words.pkl', 'wb') as stem_file:
        pickle.dump(stem_words, stem_file)
    with open('tag_classes.pkl', 'wb') as classes_file:
